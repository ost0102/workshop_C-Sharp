window.onload = function () {
    $('.lnb > li:last-child > a').addClass('menu_on')
}

var rereply = "<div class='write_coc'><div class='input_coc_box'> <div class='coc_nm'><input type='text' placeholder='이름' class='input_coc_nm' name ='Reply_Re' disabled/></div><div class='coc_cont'><textarea class='input_coc_cont' id = 'Reply_Re_Contents'></textarea></div><div class='coc_input'><button type='button'class='input_coc' id='Reply_Re_input'>입력</button></div></div ></div >";
...
$(function () {
    ...
    if (_fnToNull($("#Session_EMAIL").val()) == "") {
        $("#Reply_Contents").attr("disabled", true);
        $("#Reply_Contents").attr("placeholder", "댓글을 입력하려면 로그인을 해야합니다.");
        $("#Reply_input").attr("disabled", true);
    }
